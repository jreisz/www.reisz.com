...
{
	var borndate=1984;
	$('#age').html(parseInt(new Date($.now()).getFullYear()) -  borndate)
}		
...
function lazyLoad(poContainer)
{
	...
	if(parseInt(new Date($.now()).getHours()) >= 0 &&
       parseInt(new Date($.now()).getHours()) <= 5)	   {
		 lstrSource      = lstrSource    + '1.jpg'
	}else if(parseInt(new Date($.now()).getHours()) >= 6 &&
       parseInt(new Date($.now()).getHours()) <= 8)	   {
		 lstrSource      = lstrSource    + '2.jpg'
	}else if(parseInt(new Date($.now()).getHours()) >= 9 &&
       parseInt(new Date($.now()).getHours()) <= 10)	   {
		 lstrSource      = lstrSource    + '3.jpg'
	}else if(parseInt(new Date($.now()).getHours()) >= 11 &&
       parseInt(new Date($.now()).getHours()) <= 12)	   {
		 lstrSource      = lstrSource    + '4.jpg'
	}else if(parseInt(new Date($.now()).getHours()) >= 13 &&
       parseInt(new Date($.now()).getHours()) <= 14)	   {
		 lstrSource      = lstrSource    + '5.jpg'
	}else if(parseInt(new Date($.now()).getHours()) >= 15 &&
       parseInt(new Date($.now()).getHours()) <= 16)	   {
		 lstrSource      = lstrSource    + '4.jpg'
	}else if(parseInt(new Date($.now()).getHours()) >= 17 &&
       parseInt(new Date($.now()).getHours()) <= 18)	   {
		 lstrSource      = lstrSource    + '2.jpg'
	}else if(parseInt(new Date($.now()).getHours()) >= 19 &&
       parseInt(new Date($.now()).getHours()) <= 23)	   {
		 lstrSource      = lstrSource    + '1.jpg'
	}
	...
	$('<img>').attr('src', lstrSource).load(function()
	{
		...
		poContainer.css('background-repeat', 'no-repeat');
		poContainer.css('background-attachment', 'fixed');
